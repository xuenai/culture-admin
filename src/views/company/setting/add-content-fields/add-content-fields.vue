  ...
  <div class="wrap">
    ...
    <div class="right-panel">
      ...
      <Form ref="params" :label-width="150" class="table" :model="params" :rules="ruleValidate">
        <FormItem label="景区名称" class="mt20" prop="fieldName">
        ...
        <FormItem label="字段代码" class="mt20" prop="fieldCode">
          <Input type="text" class="control" placeholder="请输入字段代码" v-model="params.fieldCode"/>
        </FormItem>
        ...
        <FormItem label="默认显示值" class="mt20">
          <Input v-model="params.defaultValue" type="text" placeholder="请输入默认显示值" class="control"/>
        </FormItem>
...
export default class ContentFields extends Vue {
  ...
  // 高级验证ID
  private setId(e: any) {
    this.params.validateRule = this.bestList[e].name;
