    ...
    <div class="container pd15">
        ...
        <Form class="mt15" ref="params" :label-width="100" :model="params" :rules="ruleValidate" @submit.native.prevent>
            <FormItem label="景区名称：" prop="name">
                <Input class="control" v-model="params.name" placeholder="请输入景区名称" @keyup.enter.native="handlerSearch"/>
            </FormItem>
            <FormItem label="行政区域：">
    ...
    export default class list extends Vue {
        ...
        handlerSearch(){
            ...
            (this.$refs.params as any).validate((valid: any) => {
                ...
                _this.$router.push({path:'/scenic-search-list',query:{name:_this.params.name,region:_this.params.region,cityName:_this.params.cityName}});
            });
        }
    }
</script>
