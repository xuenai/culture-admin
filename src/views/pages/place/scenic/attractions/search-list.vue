    ...
    <div v-if="!loading">
      <router-link
        :to="{
          ...
          query: { scenicId: this.$route.query.scenicId }
        }"
...
export default class list extends Vue {
  ...
  mounted() {
    ...
    this.params.qyCode = this.$route.query.resourceCode
    this.cityName = this.$route.query.cityName
    if (this.params.qyCode) {
      this.getList()
    }
  }
}
