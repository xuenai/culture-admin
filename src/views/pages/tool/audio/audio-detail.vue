<template>
  <div class="pd20">
    ...
    <Row class="item mt20">
      <Col span="4" class="label-name">音频名称</Col>
    ...
    <Row class="item mt20" v-if="detail.data.placeType">
      ...
      <Col span="20" class="item-content">
        ...
        <span v-if="detail.data.placeType==='CONTENT'">内容</span>
      </Col>
    </Row>
    ...
    <Row class="item mg20">
      <Col span="24">
        <router-link :to="{path: '/audio-edit', query:{id: detail.data.id}}">
    ...
    <!-- 播放音频 -->
    <VoicePop :show="showVoice" style="width: 500px" :close="()=>{showVoice = false}" :voiceConf="voiceConf"></VoicePop>
  </div>
</template>

<script lang='ts'>
import { Component, Vue } from "vue-property-decorator";
import { getVoiceInfo , getResourceByType } from "@service/tool";
