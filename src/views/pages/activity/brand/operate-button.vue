<template>
    <div class="btn-box">
        <Button type="primary" :disabled="order" v-if="operates.includes('recommend')" @click="setOperateStatus(1, 'RECOMMEND')">推荐</Button>
        <Button type="primary" :disabled="order" v-if="operates.includes('cancelRecommend')" @click="setOperateStatus(0, 'RECOMMEND')">取消推荐
        </Button>
...
<script lang='ts'>
    ...
    export default class FooterButtons extends Vue {
        ...
        @Prop({default: 'BRAND'}) private relationType!:string; // 
