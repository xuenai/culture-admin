<template>
  <div class="list-panel">
    ...
    <Row class="item">
      <i-col span="2" class="item-name">类别</i-col>
      <i-col span="22" class="item-content">{{data.type}}</i-col>
    </Row>
    <Row class="item">
      <i-col span="2" class="item-name">级别</i-col>
      <i-col span="22" class="item-content">{{data.level}}</i-col>
    </Row>
    <Row class="item">
      <i-col span="2" class="item-name">批次</i-col>
      <i-col span="22" class="item-content">{{data.batch}}</i-col>
    </Row>
    <Row class="item">
      <i-col span="2" class="item-name">非遗体验项目</i-col>
      <i-col span="22" class="item-content">{{data.heritageItem}}</i-col>
    </Row>  
    <Row class="item">
