<template>
    <div class="perform-wrap">
        <!--场馆详情-->
        <venuesDetail :audit="audit"></venuesDetail>
        <!--审核通过/不通过-->
...
<script lang="ts">
    ...
    import venuesDetail from '@views/pages/place/venues/venues-index/detail.vue'
    import roomDetail from '@views/pages/place/venues/activity-room/detail.vue'
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName: '',//资源名称
            resourceType: 'CONTENT_TYPE_VENUE',//资源类型
            auditResult: '',//审核内容,
            auditType: 1
        };
        //设置快捷回复
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-venues-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        created(){
