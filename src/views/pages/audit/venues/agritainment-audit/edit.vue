        ...
        <div class="form-wrap pd20">
            <Form :label-width="100">
                ...
                <FormItem class="item submit mt20">
                    <Button type="primary" class="btn" @click="saveAudit(1)" v-if="!data.isPass">审核</Button>
                    <Button type="primary" class="btn" @click="saveAudit(1)" v-else>保存</Button>
...
<script lang="ts">
    ...
    import detail from '@views/pages/place/agritainment/detail.vue'
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName:'',//资源名称
            resourceType: 'CONTENT_TYPE_AGRITAINMENT',//资源类型
            auditResult: '',//审核内容,
            auditType: 1
        };
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-agritainment-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        mounted() {
