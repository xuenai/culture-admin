        ...
        <div class="form-wrap pd20">
            <Form :label-width="100">
                ...
                <FormItem class="item mt20" label="审核备注：" v-if="data.isPass" :required="true" :error="error">
                    <Input type="textarea" :maxlength="200" :rows="4" class="remark" v-model="params.auditResult" placeholder="请写下审核备注，不通过时审核备注必须填写，200字以内"/>
                    <span>200字以内</span>
                </FormItem>
...
<script lang="ts">
    ...
    import detail from '@views/pages/place/parking/detail.vue'
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName: '',//资源名称
            resourceType: 'CONTENT_TYPE_PARKING',//资源类型
            auditResult: '',//审核内容,
            auditType: 1
        };
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-parking-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        mounted() {
