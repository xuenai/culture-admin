<template>
    <div class="perform-wrap">
        <!--景区详情-->
        <scenicDetail :audit="audit"></scenicDetail>
        <!--审核通过/不通过-->
...
<script lang="ts">
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName: '',//资源名称
            resourceType: 'CONTENT_TYPE_SCENERY',//资源类型
            auditResult: '',//审核内容,
            auditType: 1
        };
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-scenic-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        created(){
