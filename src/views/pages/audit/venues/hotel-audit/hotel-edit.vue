<template>
    <div class="perform-wrap">
        <!--酒店详情-->
        <hotelDetail :audit="audit"></hotelDetail>
        <!--审核通过/不通过-->
...
<script lang="ts">
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName: '',//资源名称
            resourceType: 'CONTENT_TYPE_HOTEL',//资源类型
            auditResult: '',//审核内容,
            auditType: 1
        };
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-hotel-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        created(){
