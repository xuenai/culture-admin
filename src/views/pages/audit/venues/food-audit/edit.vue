...
<script lang="ts">
    ...
    import detail from '@views/pages/place/food/detail.vue'
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName:'',//资源名称
            resourceType: 'CONTENT_TYPE_RESTAURANT',//资源类型
            auditResult: '',//审核内容,
            auditType: 1
        };
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-food-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        mounted() {
