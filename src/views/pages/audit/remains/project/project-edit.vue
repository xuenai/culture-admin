<template>
    <div class="perform-wrap">
        <!--非遗项目详情-->
        <projectDetail :audit="audit"></projectDetail>
        <!--审核通过/不通过-->
...
<script lang="ts">
    ...
    import projectDetail from '@views/pages/activity/remains/project/detail.vue'
    ...
    export default class auditPerform extends Vue {
        ...
        private params: any = {
            ...
            resourceId: '',//资源ID
            resourceName: '',//资源名称
            resourceType: 'CONTENT_TYPE_HERITAGE_ITEM',//资源类型
            auditResult: '',//审核内容
            auditType: 1,//审核方式
        };
        //保存审核
        ...
        //修改
        goEdit(){
            this.$router.push({path: '/audit-project-modify', query: {id: this.$route.query.id, type: 'audit'}});
        }
        created(){
