 ...
 * @Last Modified time: 2020-04-07 16:59:23
 */
// 活动部分的路由
export default [
  {
    ...
    component: () => import('@/views/pages/activity/activity-survey/activity-survey.vue'),
  },
  {
    path: '/ac-survey-res',
    name: 'ac-survey-res',
  ...
  },
  {
    ...
    component: () => import('@/views/pages/activity/add-activity/booking-activity.vue'),
  },
  {
    path: '/ac-free-add',
    name: 'ac-free-add',
    component: () => import('@/views/pages/activity/add-activity/free-booking.vue'),
    meta: {
      title: '免费预订',
      menu: '/ac-add'
    },
  ...
  },
  {
    ...
    component: () => import('@/views/pages/activity/add-activity/add-activity-volunt.vue'),
    meta: {
      title: '志愿招募',
      menu: '/ac-add'
    },
  ...
  },
  {
    ...
    component: () => import('@/views/pages/activity/add-activity/add-money-activity.vue'),
    meta: {
      title: '付费活动',
      menu: '/ac-add'
    },
  ...
  },
  {
    ...
    component: () => import('@/views/pages/activity/add-activity/add-activity-other.vue'),
    meta: {
      title: '其他活动',
      menu: '/ac-add'
    },
  ...
  },
  {
    path: '/ac-list',
    name: 'ac-list',
    component: () => import('@/views/pages/activity/activity-management/activity-management.vue'),
    meta: {
      title: '活动管理'
    },
  },
  {
    path: '/ac-detail',
    name: 'ac-detail',
    component: () => import('@/views/pages/activity/activity-management/activity-detail.vue'),
    meta: {
      title: '活动详情',
      menu: '/ac-list'
    }
  },
  {
    path: '/ac-order-list',
    name: 'ac-order-list',
    component: () => import('@/views/pages/activity/activity-order/order-list.vue'),
    meta: {
      title: '活动订单'
    }
  },
  ...
  },
  {
    ...
    component: () => import('@views/pages/activity/remains/profile/profile.vue'),
    meta: {
      title: '概况'
    }
  },
  ...
  },
  {
    path: '/experience-add',
    name: 'experience-add',
    component: () => import('@views/pages/activity/remains/experience-base/add.vue'),
    meta: {
  ...
  },
  {
    ...
    component: () => import('@views/pages/activity/remains/experience-base/list.vue'),
    meta: {
      title: '体验基地'
    }
  },
  {
    ...
    component: () => import('@views/pages/activity/remains/experience-base/detail.vue'),
    meta: {
      menu: '/experience-list',
      title: '体验基地详情'
    }
  },
  {
    path: '/inherit-add',
    name: 'inherit-add',
    component: () => import('@views/pages/activity/remains/inherit-base/add.vue'),
    meta: {
      menu: '/inherit-list',
      title: '添加传习基地'
    }
  },
  {
    path: '/inherit-list',
    name: 'inherit-list',
    component: () => import('@views/pages/activity/remains/inherit-base/list.vue'),
    meta: {
      title: '传习基地'
    }
  },
  {
    ...
    name: 'inherit-detail',
    component: () => import('@views/pages/activity/remains/inherit-base/detail.vue'),
    meta: {
      menu: '/inherit-list',
      title: '传习基地详情'
    }
  },
  {
    path: '/protect-add',
    name: 'protect-add',
    component: () => import('@views/pages/activity/remains/protect-base/add.vue'),
    meta: {
      menu: '/protect-list',
      title: '添加生产性保护基地'
    }
  },
  {
    path: '/protect-list',
    name: 'protect-list',
    component: () => import('@views/pages/activity/remains/protect-base/list.vue'),
    meta: {
      title: '生产性基地'
    }
  },
  {
    ...
    name: 'protect-detail',
    component: () => import('@views/pages/activity/remains/protect-base/detail.vue'),
    meta: {
      menu: '/protect-list',
      title: '生产性基地详情'
    }
